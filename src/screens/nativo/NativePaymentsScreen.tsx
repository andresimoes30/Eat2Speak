...
const mockTransactions: Transaction[] = [
  ...
  {
    id: 3,
    title: "Sesión con Pierre Dubois",
    amount: "+€25.00",
    date: "02 Mayo, 2025",
    status: "paid"
  },
...
export default function NativePaymentsScreen() {
  ...
  const goToPaymentMethods = () => {
    ...
    navigation.navigate("NativePaymentMethods")
  }
      ...
      <Card style={styles.balanceCard}>
        <View style={styles.balanceContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              // Navigate to PaymentMethods
              // @ts-ignore - Ignore type checking for this line
              navigation.navigate("NativePaymentMethods")
            }}
          >
            <Ionicons name="cash-outline" size={18} color="white" />
            <Text style={styles.addButtonText}>{t("payments.withdraw")}</Text>
          </TouchableOpacity>
        </View>
      </Card>
