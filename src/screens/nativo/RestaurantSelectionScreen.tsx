...
type RestaurantSelectionNavigationProp = NativeStackNavigationProp<
  AvailabilityStackParamList,
  'RestaurantSelection'
>;

type RestaurantSelectionRouteProp = RouteProp<
  AvailabilityStackParamList,
  'RestaurantSelection'
>;
...
export default function RestaurantSelectionScreen() {
  ...
  const navigation = useNavigation<RestaurantSelectionNavigationProp>();
  const route = useRoute<RestaurantSelectionRouteProp>();
  
  // Initialize with route params or fallback to context
  const [selectedRestaurants, setSelectedRestaurants] = useState<number[]>(
    route.params?.selectedRestaurants || appState.selectedRestaurants || []
  );
  ...
  useEffect(() => {
    console.log("RestaurantSelectionScreen rendered");
  }, []);
  ...
  // Save selection and return to availability screen
  const saveSelection = () => {
    updateAppState({ selectedRestaurants });
    // Show a brief success message
    Alert.alert(
      "Restaurantes Guardados",
      `Has seleccionado ${selectedRestaurants.length} restaurantes favoritos.`,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.filtersGrid}>
        <View style={styles.filterItem}>
          ...
          >
            <Text>{filterCity === "all" ? "Ciudad" : filterCity}</Text>
        ...
        <View style={styles.filterItem}>
          ...
          >
            <Text>{filterCuisine === "all" ? "Cocina" : filterCuisine}</Text>
        ...
        <View style={styles.filterItem}>
          ...
          >
            <Text>{filterLanguage === "all" ? "Idioma" : filterLanguage}</Text>
      ...
      <View style={styles.resultsCounter}>
        <Text style={styles.counterText}>{filteredRestaurants.length} restaurantes encontrados</Text>
        <Text style={styles.counterText}>{selectedRestaurants.length} seleccionados</Text>
      </View>
                ...
                <View style={styles.statusContainer}>
                  <View style={[
                    ...
                    <Text style={styles.statusText}>
                      {restaurant.available ? "Disponible" : "No disponible"}
                    </Text>
                  </View>
      ...
      <View style={styles.actionButtons}>
        ...
        >
          <Text style={styles.saveButtonText}>
            {selectionChanged 
              ? `Guardar (${selectedRestaurants.length})` 
              : "Sin cambios"}
          </Text>
        </TouchableOpacity>
      </View>
